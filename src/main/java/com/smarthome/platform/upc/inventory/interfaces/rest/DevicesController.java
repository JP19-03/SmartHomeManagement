...
public class DevicesController {
    ...
    /**
     * Create a new device
     * @param resource the {@link CreateDeviceResource} with the device data
     * @return A {@link ResponseEntity} with the created device, or a bad request if the input is invalid
     */
    @PostMapping
     ...
     * @param resource the {@link UpdateDeviceResource} with the device data
     * @return A {@link ResponseEntity} with the updated device, or a bad request if the input is invalid
     */
    @PutMapping("/{id}")
