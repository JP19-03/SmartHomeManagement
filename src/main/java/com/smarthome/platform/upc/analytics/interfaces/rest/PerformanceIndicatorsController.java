...
/**
 * REST controller for managing performance indicators
...
public class PerformanceIndicatorsController {
     ...
     * @param resource the {@link CreatePerformanceIndicatorResource} with the performance indicator data
     * @return A {@link ResponseEntity} with the created performance indicator, or a bad request if the performance indicator could not be created
     */
    @PostMapping
